...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DBFConfiguration.dbf_type'
        db.add_column('lizard_wbconfiguration_dbfconfiguration', 'dbf_type', self.gf('django.db.models.fields.CharField')(default=datetime.date(2011, 12, 8), max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DBFConfiguration.dbf_type'
        db.delete_column('lizard_wbconfiguration_dbfconfiguration', 'dbf_type')
