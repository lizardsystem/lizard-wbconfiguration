...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaConfiguration.min_concentr_so4_precipitation'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'min_concentr_so4_precipitation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.min_concentr_so4_seepage'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'min_concentr_so4_seepage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.incr_concentr_so4_precipitation'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'incr_concentr_so4_precipitation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.incr_concentr_so4_seepage'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'incr_concentr_so4_seepage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AreaConfiguration.min_concentr_so4_precipitation'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'min_concentr_so4_precipitation')

        # Deleting field 'AreaConfiguration.min_concentr_so4_seepage'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'min_concentr_so4_seepage')

        # Deleting field 'AreaConfiguration.incr_concentr_so4_precipitation'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'incr_concentr_so4_precipitation')

        # Deleting field 'AreaConfiguration.incr_concentr_so4_seepage'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'incr_concentr_so4_seepage')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 3, 13, 24, 24, 340282)'}),
