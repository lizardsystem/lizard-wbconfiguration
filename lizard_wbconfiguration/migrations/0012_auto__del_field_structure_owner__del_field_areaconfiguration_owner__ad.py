...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Structure.owner'
        db.delete_column('lizard_wbconfiguration_structure', 'owner')

        # Deleting field 'AreaConfiguration.owner'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'owner')

        # Adding field 'AreaConfiguration.data_set'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'data_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataSet'], null=True, blank=True), keep_default=False)

        # Deleting field 'Bucket.owner'
        db.delete_column('lizard_wbconfiguration_bucket', 'owner')

        # Adding field 'Bucket.data_set'
        db.add_column('lizard_wbconfiguration_bucket', 'data_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataSet'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Structure.owner'
        db.add_column('lizard_wbconfiguration_structure', 'owner', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.owner'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'owner', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Deleting field 'AreaConfiguration.data_set'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'data_set_id')

        # Adding field 'Bucket.owner'
        db.add_column('lizard_wbconfiguration_bucket', 'owner', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Deleting field 'Bucket.data_set'
        db.delete_column('lizard_wbconfiguration_bucket', 'data_set_id')
