...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('lizard_wbconfiguration_structure', 'in_out')


    def backwards(self, orm):
        
        # Adding field 'Structure.in_out'
        db.add_column('lizard_wbconfiguration_structure', 'in_out', self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True), keep_default=False)
