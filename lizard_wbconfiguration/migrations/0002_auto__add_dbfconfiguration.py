...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DBFConfiguration'
        db.create_table('lizard_wbconfiguration_dbfconfiguration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filepath', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('lizard_wbconfiguration', ['DBFConfiguration'])


    def backwards(self, orm):
        
        # Deleting model 'DBFConfiguration'
        db.delete_table('lizard_wbconfiguration_dbfconfiguration')
