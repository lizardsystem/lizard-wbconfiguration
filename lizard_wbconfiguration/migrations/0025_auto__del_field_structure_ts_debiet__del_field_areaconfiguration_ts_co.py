...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('lizard_wbconfiguration_structure', 'ts_debiet_id')

        # Deleting field 'AreaConfiguration.ts_concentr_chloride_2'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'ts_concentr_chloride_2_id')

        # Deleting field 'AreaConfiguration.ts_wegz'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'ts_wegz_id')

        # Deleting field 'AreaConfiguration.ts_water_level'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'ts_water_level_id')

        # Deleting field 'AreaConfiguration.ts_concentr_chloride_1'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'ts_concentr_chloride_1_id')

        # Deleting field 'AreaConfiguration.ts_kwel'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'ts_kwel_id')

        # Deleting field 'AreaConfiguration.ts_evaporation'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'ts_evaporation_id')

        # Deleting field 'AreaConfiguration.ts_precipitation'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'ts_precipitation_id')

        # Deleting field 'AreaConfiguration.ts_sp'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'ts_sp_id')

        # Deleting field 'Bucket.ts_referenceoverflow'
        db.delete_column('lizard_wbconfiguration_bucket', 'ts_referenceoverflow_id')

        # Deleting field 'Bucket.ts_flowoff'
        db.delete_column('lizard_wbconfiguration_bucket', 'ts_flowoff_id')

        # Deleting field 'Bucket.ts_drainageindraft'
        db.delete_column('lizard_wbconfiguration_bucket', 'ts_drainageindraft_id')

        # Deleting field 'Bucket.ts_kwelwegz'
        db.delete_column('lizard_wbconfiguration_bucket', 'ts_kwelwegz_id')


    def backwards(self, orm):
        
        # Adding field 'Structure.ts_debiet'
        db.add_column('lizard_wbconfiguration_structure', 'ts_debiet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_debiet', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.ts_concentr_chloride_2'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'ts_concentr_chloride_2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_concentr_chloride_2', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.ts_wegz'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'ts_wegz', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_wegz', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.ts_water_level'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'ts_water_level', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_water_level', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.ts_concentr_chloride_1'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'ts_concentr_chloride_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_concentr_chloride_1', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.ts_kwel'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'ts_kwel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_kwel', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.ts_evaporation'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'ts_evaporation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_evaporation', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.ts_precipitation'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'ts_precipitation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_precipitation', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.ts_sp'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'ts_sp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sp', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'Bucket.ts_referenceoverflow'
        db.add_column('lizard_wbconfiguration_bucket', 'ts_referenceoverflow', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_referenceoverflow_bucket', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'Bucket.ts_flowoff'
        db.add_column('lizard_wbconfiguration_bucket', 'ts_flowoff', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_flowoff_bucket', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'Bucket.ts_drainageindraft'
        db.add_column('lizard_wbconfiguration_bucket', 'ts_drainageindraft', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_drainageindraf_bucket', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)

        # Adding field 'Bucket.ts_kwelwegz'
        db.add_column('lizard_wbconfiguration_bucket', 'ts_kwelwegz', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ts_kwelwegz_bucket', null=True, to=orm['lizard_fewsnorm.TimeSeriesCache'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 2, 11, 36, 5, 502449)'}),
