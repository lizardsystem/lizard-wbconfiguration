...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DBFConfiguration.data_set'
        db.add_column('lizard_wbconfiguration_dbfconfiguration', 'data_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataSet'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DBFConfiguration.data_set'
        db.delete_column('lizard_wbconfiguration_dbfconfiguration', 'data_set_id')
