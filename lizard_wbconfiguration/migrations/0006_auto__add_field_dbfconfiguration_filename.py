...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DBFConfiguration.filename'
        db.add_column('lizard_wbconfiguration_dbfconfiguration', 'filename', self.gf('django.db.models.fields.CharField')(default=datetime.date(2011, 12, 8), max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DBFConfiguration.filename'
        db.delete_column('lizard_wbconfiguration_dbfconfiguration', 'filename')
