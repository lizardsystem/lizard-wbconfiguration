...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaConfiguration.fews_meta_info'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'fews_meta_info', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Structure.fews_meta_info'
        db.add_column('lizard_wbconfiguration_structure', 'fews_meta_info', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)

        # Adding field 'Bucket.fews_meta_info'
        db.add_column('lizard_wbconfiguration_bucket', 'fews_meta_info', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AreaConfiguration.fews_meta_info'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'fews_meta_info')

        # Deleting field 'Structure.fews_meta_info'
        db.delete_column('lizard_wbconfiguration_structure', 'fews_meta_info')

        # Deleting field 'Bucket.fews_meta_info'
        db.delete_column('lizard_wbconfiguration_bucket', 'fews_meta_info')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 6, 9, 25, 29, 736442)'}),
