...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WBConfigurationDBFMapping.index'
        db.add_column('lizard_wbconfiguration_wbconfigurationdbfmapping', 'index', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WBConfigurationDBFMapping.index'
        db.delete_column('lizard_wbconfiguration_wbconfigurationdbfmapping', 'index')
