...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaConfiguration.ts_cl'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'ts_cl', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AreaConfiguration.ts_cl'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'ts_cl')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 12, 10, 29, 34, 143014)'}),
