...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Structure.in_out'
        db.add_column('lizard_wbconfiguration_structure', 'in_out', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_wbconfiguration.StructureInOut'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Structure.in_out'
        db.delete_column('lizard_wbconfiguration_structure', 'in_out_id')
