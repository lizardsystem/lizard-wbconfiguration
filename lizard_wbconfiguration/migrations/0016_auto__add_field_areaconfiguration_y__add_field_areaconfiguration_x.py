...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AreaConfiguration.y'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'y', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=9, blank=True), keep_default=False)

        # Adding field 'AreaConfiguration.x'
        db.add_column('lizard_wbconfiguration_areaconfiguration', 'x', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=9, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AreaConfiguration.y'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'y')

        # Deleting field 'AreaConfiguration.x'
        db.delete_column('lizard_wbconfiguration_areaconfiguration', 'x')
