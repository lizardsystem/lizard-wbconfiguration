...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Structure.y'
        db.add_column('lizard_wbconfiguration_structure', 'y', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=9, blank=True), keep_default=False)

        # Adding field 'Structure.x'
        db.add_column('lizard_wbconfiguration_structure', 'x', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=9, blank=True), keep_default=False)

        # Adding field 'Bucket.y'
        db.add_column('lizard_wbconfiguration_bucket', 'y', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=9, blank=True), keep_default=False)

        # Adding field 'Bucket.x'
        db.add_column('lizard_wbconfiguration_bucket', 'x', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=9, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Structure.y'
        db.delete_column('lizard_wbconfiguration_structure', 'y')

        # Deleting field 'Structure.x'
        db.delete_column('lizard_wbconfiguration_structure', 'x')

        # Deleting field 'Bucket.y'
        db.delete_column('lizard_wbconfiguration_bucket', 'y')

        # Deleting field 'Bucket.x'
        db.delete_column('lizard_wbconfiguration_bucket', 'x')
