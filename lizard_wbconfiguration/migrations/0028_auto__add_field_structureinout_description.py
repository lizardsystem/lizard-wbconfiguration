...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StructureInOut.description'
        db.add_column('lizard_wbconfiguration_structureinout', 'description', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StructureInOut.description'
        db.delete_column('lizard_wbconfiguration_structureinout', 'description')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 3, 6, 10, 57, 37, 870196)'}),
