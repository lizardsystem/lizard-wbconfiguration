...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Structure.data_set'
        db.add_column('lizard_wbconfiguration_structure', 'data_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_security.DataSet'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Structure.data_set'
        db.delete_column('lizard_wbconfiguration_structure', 'data_set_id')
