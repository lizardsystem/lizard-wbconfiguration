...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'BucketsType', fields ['bucket_type']
        db.delete_unique('lizard_wbconfiguration_bucketstype', ['bucket_type'])

        # Adding unique constraint on 'BucketsType', fields ['code']
        db.create_unique('lizard_wbconfiguration_bucketstype', ['code'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BucketsType', fields ['code']
        db.delete_unique('lizard_wbconfiguration_bucketstype', ['code'])

        # Adding unique constraint on 'BucketsType', fields ['bucket_type']
        db.create_unique('lizard_wbconfiguration_bucketstype', ['bucket_type'])
