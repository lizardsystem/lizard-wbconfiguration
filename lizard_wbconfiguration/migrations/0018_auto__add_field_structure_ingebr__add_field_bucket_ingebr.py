...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Structure.ingebr'
        db.add_column('lizard_wbconfiguration_structure', 'ingebr', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Bucket.ingebr'
        db.add_column('lizard_wbconfiguration_bucket', 'ingebr', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Structure.ingebr'
        db.delete_column('lizard_wbconfiguration_structure', 'ingebr')

        # Deleting field 'Bucket.ingebr'
        db.delete_column('lizard_wbconfiguration_bucket', 'ingebr')
