...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DBFConfiguration.enabled'
        db.add_column('lizard_wbconfiguration_dbfconfiguration', 'enabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DBFConfiguration.enabled'
        db.delete_column('lizard_wbconfiguration_dbfconfiguration', 'enabled')
