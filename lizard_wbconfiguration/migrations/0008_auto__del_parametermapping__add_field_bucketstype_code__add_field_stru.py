...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BucketsType.code'
        db.add_column('lizard_wbconfiguration_bucketstype', 'code', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Structure.is_specified'
        db.add_column('lizard_wbconfiguration_structure', 'is_specified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Bucket.is_computed'
        db.delete_column('lizard_wbconfiguration_bucket', 'is_computed')

        # Adding field 'Bucket.equi_water_level'
        db.add_column('lizard_wbconfiguration_bucket', 'equi_water_level', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Bucket.bottom_equi_water_level'
        db.add_column('lizard_wbconfiguration_bucket', 'bottom_equi_water_level', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('lizard_wbconfiguration_parametermapping', (
            ('ident_wbconfiguration', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True)),
        ...
        # Deleting field 'BucketsType.code'
        db.delete_column('lizard_wbconfiguration_bucketstype', 'code')

        # Deleting field 'Structure.is_specified'
        db.delete_column('lizard_wbconfiguration_structure', 'is_specified')

        # Adding field 'Bucket.is_computed'
        db.add_column('lizard_wbconfiguration_bucket', 'is_computed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Bucket.equi_water_level'
        db.delete_column('lizard_wbconfiguration_bucket', 'equi_water_level')

        # Deleting field 'Bucket.bottom_equi_water_level'
        db.delete_column('lizard_wbconfiguration_bucket', 'bottom_equi_water_level')
    ...
    models = {
        ...
        'lizard_wbconfiguration.bucket': {
            ...
            'bottom_equi_water_level': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '3', 'blank': 'True'}),
            ...
            'equi_water_level': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '3', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'lizard_wbconfiguration.structure': {
            ...
            'is_specified': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
