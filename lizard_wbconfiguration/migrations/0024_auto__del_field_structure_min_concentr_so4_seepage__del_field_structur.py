...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Structure.min_concentr_so4_seepage'
        db.delete_column('lizard_wbconfiguration_structure', 'min_concentr_so4_seepage')

        # Deleting field 'Structure.incr_concentr_so4_precipitation'
        db.delete_column('lizard_wbconfiguration_structure', 'incr_concentr_so4_precipitation')

        # Deleting field 'Structure.min_concentr_so4_precipitation'
        db.delete_column('lizard_wbconfiguration_structure', 'min_concentr_so4_precipitation')

        # Deleting field 'Structure.incr_concentr_so4_seepage'
        db.delete_column('lizard_wbconfiguration_structure', 'incr_concentr_so4_seepage')

        # Adding field 'Structure.min_concentr_so4'
        db.add_column('lizard_wbconfiguration_structure', 'min_concentr_so4', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Structure.incr_concentr_so4'
        db.add_column('lizard_wbconfiguration_structure', 'incr_concentr_so4', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Deleting field 'Bucket.min_concentr_so4_seepage'
        db.delete_column('lizard_wbconfiguration_bucket', 'min_concentr_so4_seepage')

        # Deleting field 'Bucket.incr_concentr_so4_precipitation'
        db.delete_column('lizard_wbconfiguration_bucket', 'incr_concentr_so4_precipitation')

        # Deleting field 'Bucket.incr_concentr_so4_seepage'
        db.delete_column('lizard_wbconfiguration_bucket', 'incr_concentr_so4_seepage')

        # Deleting field 'Bucket.min_concentr_so4_precipitation'
        db.delete_column('lizard_wbconfiguration_bucket', 'min_concentr_so4_precipitation')

        # Adding field 'Bucket.min_concentr_so4_flow_off'
        db.add_column('lizard_wbconfiguration_bucket', 'min_concentr_so4_flow_off', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Bucket.min_concentr_so4_drainage_indraft'
        db.add_column('lizard_wbconfiguration_bucket', 'min_concentr_so4_drainage_indraft', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Bucket.incr_concentr_so4_flow_off'
        db.add_column('lizard_wbconfiguration_bucket', 'incr_concentr_so4_flow_off', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Bucket.incr_concentr_so4_drainage_indraft'
        db.add_column('lizard_wbconfiguration_bucket', 'incr_concentr_so4_drainage_indraft', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Structure.min_concentr_so4_seepage'
        db.add_column('lizard_wbconfiguration_structure', 'min_concentr_so4_seepage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Structure.incr_concentr_so4_precipitation'
        db.add_column('lizard_wbconfiguration_structure', 'incr_concentr_so4_precipitation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Structure.min_concentr_so4_precipitation'
        db.add_column('lizard_wbconfiguration_structure', 'min_concentr_so4_precipitation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Structure.incr_concentr_so4_seepage'
        db.add_column('lizard_wbconfiguration_structure', 'incr_concentr_so4_seepage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Deleting field 'Structure.min_concentr_so4'
        db.delete_column('lizard_wbconfiguration_structure', 'min_concentr_so4')

        # Deleting field 'Structure.incr_concentr_so4'
        db.delete_column('lizard_wbconfiguration_structure', 'incr_concentr_so4')

        # Adding field 'Bucket.min_concentr_so4_seepage'
        db.add_column('lizard_wbconfiguration_bucket', 'min_concentr_so4_seepage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Bucket.incr_concentr_so4_precipitation'
        db.add_column('lizard_wbconfiguration_bucket', 'incr_concentr_so4_precipitation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Bucket.incr_concentr_so4_seepage'
        db.add_column('lizard_wbconfiguration_bucket', 'incr_concentr_so4_seepage', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Adding field 'Bucket.min_concentr_so4_precipitation'
        db.add_column('lizard_wbconfiguration_bucket', 'min_concentr_so4_precipitation', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=3, blank=True), keep_default=False)

        # Deleting field 'Bucket.min_concentr_so4_flow_off'
        db.delete_column('lizard_wbconfiguration_bucket', 'min_concentr_so4_flow_off')

        # Deleting field 'Bucket.min_concentr_so4_drainage_indraft'
        db.delete_column('lizard_wbconfiguration_bucket', 'min_concentr_so4_drainage_indraft')

        # Deleting field 'Bucket.incr_concentr_so4_flow_off'
        db.delete_column('lizard_wbconfiguration_bucket', 'incr_concentr_so4_flow_off')

        # Deleting field 'Bucket.incr_concentr_so4_drainage_indraft'
        db.delete_column('lizard_wbconfiguration_bucket', 'incr_concentr_so4_drainage_indraft')
    ...
    models = {
        ...
        'lizard_area.area': {
            ...
            'dt_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 6, 12, 7, 52, 361631)'}),
